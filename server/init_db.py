...
DEFAULT_PERSONAS = [
    ...
    # },
    {
        "id": "friendly",
        "name": "Аня",
        "bio": "27 лет, живёт в Санкт-Петербурге, рядом с метро Петроградская. Работает в небольшой студии графического дизайна, вечером иногда берёт фриланс. Любит кофе с корицей, антикварные книжные магазины и фестивали уличной еды. Есть кот Миша, который любит спать на ноутбуке. Утро начинает с капучино и музыки, а выходные чаще проводит гуляя по городу с друзьями.",
